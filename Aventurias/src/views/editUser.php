        ...
        <section class="form">
            ...
            <div id="checkImages">
                ...
                <div class="col-12" id="editSubmitButton">
                    <input class="btn-lg btn-outline-success go-add-task float" type="submit" value="Aceptar"> 

                    <input class="btn-lg btn-outline-warning go-add-task float" type="reset" value="Borrar Formulario">
                </div>
            </form>
        </section>
